...
class AlibabaTabScreen extends StatefulWidget {
  AlibabaTabScreen({Key key}) : super(key: key);

  @override
  _AlibabaTabScreenState createState() => _AlibabaTabScreenState();
}

class _AlibabaTabScreenState extends State<AlibabaTabScreen> {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CategoryCubit, Category>(
      builder: (context, category) {
        ...
        // for (var i = 0; i < category.categoryInfoList.content.length; i++) {
        //   isHidden = category.categoryInfoList.content[i].isHidden;
        //   print(isHidden);
        //   print(i);
        //   category.categoryInfoList.content.removeWhere((isHidden) => true);
        // }
